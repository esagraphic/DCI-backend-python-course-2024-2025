...
from worker import Janitor, Programmer, Worker
...
class TestWorker(unittest.TestCase):
    ...
    def test_1_abstract_method_work(self):
        self.assertTrue(
            getattr(Worker.work, "__isabstractmethod__", False),
            "The method work in the class Worker is not an abstract method",
        )

    def test_2_abstract_method_take_break(self):
        self.assertTrue(
            getattr(Worker.take_break, "__isabstractmethod__", False),
            "The method take_break in the class Worker is not an abstract method",
        )
    ...
    def test_4_janitor_inheritance(self):
        ...
        self.assertIsInstance(
            j1, Worker, "The class Janitor doesn't inherit from the class Worker"
        )
